...
<html>
  <head>  
    ...
    <cms:include file="/system/workplace/commons/eurelis/responsivepreview/includes/javascript.jsp">
      <cms:param name="iframeMode"><c:out value="${iframeMode}"/></cms:param>
      <cms:param name="deviceVOList"><c:out value="${deviceVOList}"/></cms:param>
    </cms:include>
  	...
  	<table class="dialog" cellspacing="0" cellpadding="0">
		<tbody><tr><td>
			<table class="dialogbox" cellpadding="0" cellspacing="0">
				<tbody><tr><td>
					<div class="dialoghead" unselectable="on"><%= Messages.getLbl(Messages.GUI_RESPONSIVEPREVIEW_JSP_TITLE_0, locale) %></div><div class="dialogcontent" unselectable="on">
					<!-- dialogcontent start -->
